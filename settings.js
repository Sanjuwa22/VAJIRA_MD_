...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=ce12lZYK#j_U9uGFbXQxf0uyDpG3ddZrxLm4r9WwYHWktgrC60Nk' : process.env.SESSION_ID,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? '94776928548' : process.env.DELETEMSGSENDTO        
};
